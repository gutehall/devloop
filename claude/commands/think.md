...
Use this before `/plan` to explore ideas, challenge assumptions, and land on a clear direction — without touching Linear yet.
...
A structured conversation to think through what you actually want to build and why — before creating any issues. No Linear reads or writes. No commitments. Just thinking.
...
> "Ready to turn this into Linear issues? Run `/plan` and share this brief, or I can start it for you."

---

## Rules

- No Linear API calls — this command is thinking-only
