...
A structured thinking session about the future — not a ticket-creation exercise. No Linear writes until the user explicitly asks. The output is a strategy document: what the project should become, why, and what would have to be true for it to get there.
...
- List open projects and active issues (`mcp__claude_ai_Linear__list_projects`, `mcp__claude_ai_Linear__list_issues`)
...
> "Ready to turn this into a roadmap? Run `/plan` to create Linear issues from the next planning horizon, or I can start it for you."

---

## Rules

- No Linear writes during the vision session — this is thinking, not execution
